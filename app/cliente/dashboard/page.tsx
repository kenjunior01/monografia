      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <CardContent className="p-3 md:p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                <div className="flex-1">
                  <p className="text-xs md:text-sm font-medium text-blue-700">Seus Projetos</p>
                  <p className="text-lg md:text-2xl font-bold text-blue-900">3</p>
                  <p className="text-xs text-blue-600">🎯 Rumo ao sucesso!</p>
                </div>
                <FileText className="h-6 w-6 md:h-8 md:w-8 text-blue-600 self-end md:self-center" />
              </div>
            </CardContent>
          </Card>
        ...
        <Tabs defaultValue="pedidos" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4">
            <TabsTrigger value="pedidos" className="text-xs md:text-sm">Projetos</TabsTrigger>
            <TabsTrigger value="comunicacao" className="text-xs md:text-sm">Chat</TabsTrigger>
            <TabsTrigger value="revisoes" className="text-xs md:text-sm">Revisões</TabsTrigger>
